...
class LayerCollection:
    ...
    def get_layerid_module_maps(self, model):
        ...
        # print(f'name: {named_modules}')
        # print(f'key: {self.layers.keys()}')
        for layer in self.layers.keys():
            # TODO
            # FSDP case
            # layer='_fsdp_wrapped_module._fpw_module.'+layer
            # layerid_to_module[layer] = named_modules['_fsdp_wrapped_module._fpw_module.'+layer]
            layerid_to_module[layer] = named_modules[layer]
            # module_to_layerid[named_modules['_fsdp_wrapped_module._fpw_module.'+layer]] = layer
